use crate::{
    models::{DemandGroup, ProductGroup},
    ports::Repository,
};
...
pub struct PortfolioRecord<T: Repository, AppData> {
    ...
    pub product_group: ProductGroup<T::ProductId>,
}
